 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Criterion" type="{http://webservices.sabre.com/triprecord}SearchCriterionType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SearchCriteriaType {
    ...
    protected List<SearchCriterionType> criterion;
     ...
     * 
     */
    public List<SearchCriterionType> getCriterion() {
        if (criterion == null) {
            criterion = new ArrayList<SearchCriterionType>();
        }
